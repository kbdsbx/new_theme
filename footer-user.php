    ...
    <script type="text/javascript">
        window.jQuery || document.write("<script src='<?php echo new_template_uri; ?>/js/member/jquery-2.0.3.min.js'>"+"<"+"/script>");
    ...
    <!--[if IE]>
    <script type="text/javascript">
        window.jQuery || document.write("<script src='<?php echo new_template_uri; ?>/js/member/jquery-1.10.2.min.js'>"+"<"+"/script>");
        window.$ = window.jQuery;
    </script>
    <![endif]-->
    ...
    <script src="<?php echo new_template_uri; ?>/js/member/ace-extra.min.js"></script>
    ...
    <!--[if lte IE 8]>
      <script src="<?php echo new_template_uri; ?>/js/member/excanvas.min.js"></script>
    <![endif]-->
    ...
    <script src="<?php echo new_template_uri; ?>/js/member/ace.min.js"></script>
